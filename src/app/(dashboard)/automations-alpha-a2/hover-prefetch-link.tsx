...
// `automations-beta2/hover-prefetch-link.tsx` and that duplication is
// deliberate**: the two pages are independent so a bench can never break the
// live hub. Change one and decide whether the other should follow.
