...
export default async function EventsPage() {
  ...
  const attributionRows = await db
    .select({
      ...
      scheduledAt: partnerAttributionEvents.scheduledAt,
      proposalSentAt: partnerAttributionEvents.proposalSentAt,
      isValid: partnerAttributionEvents.isValid,
      externalRef: partnerAttributionEvents.externalRef,
  ...
  return (
    <EventsClient
      ...
      initialEvents={attributionRows.map((e) => ({
        ...
        partnerRefCode: e.partnerRefCode ?? null,
        partnerStatus: e.partnerStatus ?? null,
        type: e.type,
