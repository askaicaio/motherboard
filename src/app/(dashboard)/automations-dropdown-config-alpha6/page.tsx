// =============================================================
// Dropdown Config "Alpha6", route /automations-dropdown-config-alpha6
// =============================================================
// ⭐ A LAYOUT BENCH FOR THE DROPDOWN CONFIGURATION PAGE: **Search first**.
...
import { DropdownConfigAlpha6Client } from "./dropdown-config-client";
import type {
  DropdownChoiceRow,
  DropdownColumnKey,
  WebhookChoiceRow,
...
export default async function AutomationsDropdownConfigAlpha6Page() {
  await requireAuth();
