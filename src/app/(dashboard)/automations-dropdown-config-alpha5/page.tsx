// =============================================================
// Dropdown Config "Alpha5", route /automations-dropdown-config-alpha5
// =============================================================
// ⭐ A LAYOUT BENCH FOR THE DROPDOWN CONFIGURATION PAGE: **Triage queue**.
...
import { DropdownConfigAlpha5Client } from "./dropdown-config-client";
import type {
  DropdownChoiceRow,
  DropdownColumnKey,
  WebhookChoiceRow,
...
export default async function AutomationsDropdownConfigAlpha5Page() {
  await requireAuth();
