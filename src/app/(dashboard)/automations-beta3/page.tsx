          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                ⚠️ THE ROUTE MOVED TOO, later the same day: this page now lives
                at `/automations-beta3`, so the URL and the badge agree.
                "Rename their links as well, they don't match their actual name
                at the moment." Nothing serves `/automations-beta2` as this page
                any more (that path is now the OTHER bench), so an old tab on
                it lands somewhere real but wrong. See
