...
// =============================================================
// Dropdown Config Alpha1's client: **Master and detail**.
// =============================================================
...
export function DropdownConfigAlpha1Client({
  initialChoices,
  initialWebhooks,
}: {
    ...
    <TooltipProvider delay={TOOLTIP_DELAY_MS}>
      <div className="space-y-6">
        ...
        {/* ⭐⭐ THE TABS BECAME A LEFT RAIL. This is the change: the live page
            ...
            📌 SAME PATTERN AS THE HUB, deliberately: rail on the left, detail on
            the right, the selected item lifted rather than underlined. */}
        <div className="flex gap-4">
            ...
            {TABLES.map((table) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ⚠️ `tabular-nums` so 1, 45 and 428 line up in a column. On
                      the live page these sit inline and never align. */}
                  <span
                    className={cn(
          ...
          {/* ⚠️ `min-w-0` IS LOAD-BEARING on a flex child that contains a table:
              without it the flex item takes its content's min-content width and
              the 800px table pushes the rail off instead of scrolling. */}
