      ...
      <TooltipProvider delay={TOOLTIP_DELAY_MS}>
        <HealthCheckProvider>
              ...
              <div className="flex items-center gap-2">
                ...
                {/* 🛑🛑 THIS PAGE IS "Beta2" AS OF 2026-09-10, AND IT USED TO BE
                    ...
                    **Read "Beta1" in this file's prose as "this page".**
                    ⚠️ THE ROUTE MOVED TOO, later the same day: this page now
                    lives at `/automations-beta2`, so the URL and the badge
                    finally agree. "Rename their links as well, they don't match
                    their actual name at the moment." Nothing serves
                    `/automations-beta` any more, so old tabs and bookmarks on it
                    404. Full table in `@/lib/automations/versions`.
          ...
          {/* ⭐⭐ TOOLBAR STRIP, 2026-09-06: "Remove this toolbar. Use S2 as a
              ...
              `/automations-beta2` are independent files ON PURPOSE so the bench
                ...
                {AUTOMATION_SITES.map((site) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <HoverPrefetchLink
                        href={`/automations-beta2?site=${site.slug}`}
