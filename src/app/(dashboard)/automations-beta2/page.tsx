...
//
// 🛑🛑 EVERY CONTROL ON THIS PAGE IS STILL A STATIC VISUAL, INHERITED FROM
// ALPHA2. "Run health check", "N of 5 API keys live" and the three Tools at the
// foot of the Sources table are decorative <span>s, NOT working controls.
// **This is the one way Beta2 does not yet behave like the first Beta**, which
// was given real controls (a live HealthCheckProvider, real CopyApiKeyButtons,
// real links) over many rounds. Making these real was NOT part of the request
// that created this page; it was flagged to the user as the obvious next step.
// **Until then, do not describe anything here as working.**
//
