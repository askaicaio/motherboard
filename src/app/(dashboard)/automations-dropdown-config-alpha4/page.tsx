// =============================================================
// Dropdown Config "Alpha4", route /automations-dropdown-config-alpha4
// =============================================================
// ⭐ A LAYOUT BENCH FOR THE DROPDOWN CONFIGURATION PAGE: **One page, no tabs**.
...
import { DropdownConfigAlpha4Client } from "./dropdown-config-client";
import type {
  DropdownChoiceRow,
  DropdownColumnKey,
  WebhookChoiceRow,
...
export default async function AutomationsDropdownConfigAlpha4Page() {
  await requireAuth();
