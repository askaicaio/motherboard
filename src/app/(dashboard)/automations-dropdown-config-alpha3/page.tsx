// =============================================================
// Dropdown Config "Alpha3", route /automations-dropdown-config-alpha3
// =============================================================
// ⭐ A LAYOUT BENCH FOR THE DROPDOWN CONFIGURATION PAGE: **Swatch grid**.
...
import { DropdownConfigAlpha3Client } from "./dropdown-config-client";
import type {
  DropdownChoiceRow,
  DropdownColumnKey,
  WebhookChoiceRow,
...
export default async function AutomationsDropdownConfigAlpha3Page() {
  await requireAuth();
