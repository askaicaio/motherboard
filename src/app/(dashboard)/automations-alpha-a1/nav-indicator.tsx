...
// -----------------------------------------------------------------------------
// PER-CARD NAVIGATION FEEDBACK for the Automations rail, 2026-09-06.
//
// ⚠️ ALPHAA1'S OWN COPY, and the ONLY colour in it had to invert: the whole-card
// pending wash was `bg-zinc-900/[0.04]`, a dark tint for a light card, which is
// invisible on this page's dark ground. It is a LIGHT wash at 7% instead.
// **Everything else in this file is identical to the live hub's copy.**
//
// ⚠️⚠️ THIS IS THE LIVE HUB'S OWN COPY, promoted from the Beta2 bench on
// 2026-09-10 along with the page. **An identical file lives at
// `automations-beta2/nav-indicator.tsx` and that duplication is deliberate**,
// for the same reason the two page files are separate: a bench experiment must
// never be able to break the live hub. Change one and decide, deliberately,
  ...
  return (
    <>
      ...
      <span
        data-pending
        aria-hidden
        className="absolute inset-0 rounded-lg bg-[#DCE2E8]/[0.07]"
      />
