// =============================================================
// Dropdown Config "Alpha2", route /automations-dropdown-config-alpha2
// =============================================================
// ⭐ A LAYOUT BENCH FOR THE DROPDOWN CONFIGURATION PAGE: **List and inspector**.
...
import { DropdownConfigAlpha2Client } from "./dropdown-config-client";
import type {
  DropdownChoiceRow,
  DropdownColumnKey,
  WebhookChoiceRow,
...
export default async function AutomationsDropdownConfigAlpha2Page() {
  await requireAuth();
