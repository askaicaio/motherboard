...
// ⚠️ TEMPORARY DEV TEST (2026-06-18): lowered from 24h to 1 MINUTE so the GHL /
// GHL b2b auto-refresh toggles can be verified quickly. MUST BE REVERTED to
// `24 * 60 * 60 * 1000` once testing is done (and the sync-automations cron in
// vercel.json reverted from every-minute back to */5). Mirrors the prior n8n
// 1-min test (PR #67 -> reverted by PR #68).
