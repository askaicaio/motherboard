...
/** ⚠️ TEMPORARY DEV TEST (2026-07-01): 1 MINUTE so the auto health-check ->
 *  turn-off-faulty-auto-refresh flow can be watched live. REVERT to
 *  `24 * 60 * 60 * 1000` (24h) right after the test. */
